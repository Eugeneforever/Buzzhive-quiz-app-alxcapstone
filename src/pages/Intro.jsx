...
import '../pages/pages styles/Intro.css';
  ...
  return (
    <>    
      <div className='flex justify-around flex-col items-center m-5 relative'>
        ...
        <Button onClick={() => navigate('/home')} variant="contained" size = 'medium' style={{ fontWeight:'bolder', cursor: 'pointer', position:'relative', bottom: '5px'}}>Get Started</Button>
      </div>
      <Footer />
    </>
